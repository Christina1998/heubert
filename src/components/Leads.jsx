...
// :  ({ "Lead Number": lead[0].lead_number, "Lead Origin": lead[0].lead_origin, "Lead Source": lead[0].lead_source, "Lead Stage": lead[0].lead_stage, "Enagagement Score": lead[0].engagement_score });
  ...
  // const new_leads = lead?.map((data)=>{
  //   return data.lead_number;
  // })


  // console.log("New Leads", new_leads)
...
<Input.Search placeholder='Search Here' style={{margin:20, float:'right', width: 180}} 
onSearch={(text)=>{
  setSearchText(text)
}}
onChange={(e)=>{
